...
class DecoderRNN(BaseRNN):
    ...
    def __init__(self, vocab_size, seq_len, hidden_size,
        ...
        # hidden_size2
        # 数据：变化量，
        # 实验：（模型）加一层linear；换成lstm；（调参）batch_size， hidden_dim,  train/dev/test结果列在表格中
        ...
        # self.out1 = nn.Linear(self.hidden_size, self.hidden_size2)
        # self.out = nn.Linear(self.hidden_size2, self.output_size)
    ...
    def forward_step(self, input_var, hidden, encoder_outputs, function):
        ...
        predicted = F.relu(self.out(output))
        # if function:
    ...
    def forward(self, inputs=None, encoder_hidden=None, encoder_outputs=None,
        ...
        if use_teacher_forcing:
            ...
            # print("use_teacher_forcing  decoder_input: {}, decoder_input_size: {}".format(decoder_input[:5], decoder_input.size()))
            ...
            # print("decoder_input: {}, decoder_input_size: {}".format(decoder_input[:5], decoder_input.size()))
