...
class SourceField(torchtext.legacy.data.Field):
    """ Wrapper class of data.Field that forces batch_first and include_lengths to be True. """
...
class TargetField(torchtext.legacy.data.Field):
    """ Wrapper class of data.Field that forces batch_first to be True and prepend <sos> and append <eos> to sequences in preprocessing step.
